...
exports.queryConversations = async () => {
    ...
    //   let result = await axiosMastodon.get('/notifications?limit=10&type=mention');
    //   return result;
    ...
    const M = new Mastodon({
      ...
      let promise = new Promise( (resolve, reject) => M.get('notifications?limit=10&type=mention')
        .then((resp) => {
            resolve(resp.data);
        })
    );
